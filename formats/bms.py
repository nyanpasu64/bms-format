...
#
#
#         # Should we combine "from_ptr" and "insert"?
#         # from_ptr should be generated using description.
#         # But separating them (dubiously) separates parsing and BmsTrack storage.
#         @classmethod
#         def from_ptr(cls, ptr: Pointer):
#             d = cls()
#
...
#             return d
#
#         # Because who needs scopes when FUCK FUCK FUCK
#         def after(event, self: BmsTrack):
