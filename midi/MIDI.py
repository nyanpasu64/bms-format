...
'''
    ...
    ticks = int(tracks.pop(0))
    score = [ticks,]
    for i, opus_track in enumerate(tracks):
        ticks_so_far = 0
        score_track = []
        ...
        for opus_event in opus_track:
            ...
            if opus_event[0] == 'note_off' or (opus_event[0] == 'note_on' and opus_event[4] == 0):  # 4.8
                ...
                if chapitch2note_on_events.get(key):
                    ...
                    _warn('opus2score track {}: note_off with no note_on, bad pitch={}'.format(i, pitch))
                else:
                    _warn('opus2score track {}: note_off with no note_on cha={} pitch={}'.format(i, cha, pitch))
...
'''
    ...
    while i < len(score):
        ...
        channel2patch_time = {}
        set_tempo_num  = 500000 # keep most recent tempo change before start
        set_tempo_time = 0
